...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Data Lengkap Siswa: <?= $pendaftaran->nama_peserta_didik ?></h5>
            <a href="<?= base_url('admin/konfirmasi') ?>" class="btn btn-secondary btn-sm"><i class="bx bx-arrow-back"></i> Kembali</a>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <h6 class="fw-bold text-primary">A. IDENTITAS PESERTA DIDIK</h6>
                    ...
                    <h6 class="fw-bold text-primary mt-3">C. ASAL MULA PESERTA DIDIK</h6>
                ...
                <div class="col-md-6">
                    <h6 class="fw-bold text-primary">B. ORANG TUA PESERTA DIDIK</h6>
                    <table class="table table-borderless table-sm mb-4">
